...
(() => {
  ...
  // src/worker/tags.ts
  function createRegistryResults(registry2) {
    return Object.keys(registry2).map(
      (ref) => ({
        ref,
        score: 0,
        matchData: { metadata: {} },
  ...
  function filterResultsByTags(results, registry2, tags) {
    ...
    return results.filter(({ ref }) => {
      var _a, _b;
      return (_b = (_a = registry2[ref]) == null ? void 0 : _a.tags) == null ? void 0 : _b.some((tag) => selectedTags.has(tag));
    });
  }
  ...
  self.api = {
    ...
    search(_0, _1, _2) {
      return __async(this, arguments, function* (query, count, page, tags = []) {
        AssertConfig(config);
        const [index2, registry2] = yield load();
        let result;
        if (!query.trim()) {
          result = createRegistryResults(registry2);
        ...
        const filteredResult = filterResultsByTags(result, registry2, tags);
