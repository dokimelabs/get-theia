...
# registered dokimelabs "theia releases" OAuth app; a client id is PUBLIC).
$DEVICE_CLIENT_ID = if ($env:THEIA_OAUTH_CLIENT_ID) { $env:THEIA_OAUTH_CLIENT_ID } else { 'Ov23liBcKolWl6RtBvaO' }
